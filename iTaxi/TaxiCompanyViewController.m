...
@implementation TaxiCompanyViewController
@synthesize delegate;
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        _companyArray = [[[NSDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"TaxiCompany" ofType:@"plist"]] valueForKey:@"List"] retain];
    }
    return self;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    [delegate companySelected:[[_companyArray objectAtIndex:indexPath.row] valueForKey:@"Name"]];
